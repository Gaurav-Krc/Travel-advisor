...
const PlaceDetails = ({ place, selected, refProp }) => {
    ...
    return (
      <Card elevation={6}>
        <CardMedia
          style={{ height: 350 }}
          image={place.photo ? place.photo.images.large.url : 'https://keyassets.timeincuk.net/inspirewp/live/wp-content/uploads/sites/34/2021/04/Paul-Craig-The-Petersham-9-Copy-920x609.jpg'}
          title={place.name}
        />
        <CardContent>
